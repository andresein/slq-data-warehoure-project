/*
===========================================================================
Store Procedure: Load Siver Layer (Bronze -> Silver)
===========================================================================
Script Purpose:
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			END AS sls_due_dt,
			CASE WHEN sls_sales <= 0 OR sls_sales IS NULL OR sls_cust_id-sls_sales!=sls_quantity * ABS(sls_price)
		...
		PRINT '>>> - Total Duration : ' + CAST(DATEDIFF(second, @silver_start_time,@silver_end_time) AS NVARCHAR) + ' Seconds';
		PRINT '====================================';
	END TRY
	BEGIN CATCH
		PRINT '===============================================================';
